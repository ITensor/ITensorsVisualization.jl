...
R = @visualize ELn0 * ψn1n2 * hn1 * hn2 * ERn2 show=show vertex=vertex pause=true
@show R ≈ ELn0 * ψn1n2 * hn1 * hn2 * ERn2

# Split it up into multiple contractions
R1 = @visualize ELn0 * ψn1n2 * hn1 show=show vertex=vertex pause=true
R2 = @visualize R1 * hn2 * ERn2 show=show vertex=vertex pause=true
